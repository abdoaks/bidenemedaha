...
fs.readdir('./komutlar/', (err, files) => {
  ...
  log(`Toplam ${files.length} komut var.`);
  files.forEach(f => {
...
client.on('message', msg => {
  if (msg.content.toLowerCase() === 'aşkitolar') {
    msg.channel.send('Ömer ❤ Dilan');
  }
});
...
app.get('/', (req, res) => res.send('Lewix Bot | Aktif!')) 
app.listen(process.env.PORT, () => console.log('Port ayarlandı: ' + process.env.PORT))

client.on("message", msg => {
  var dm = client.channels.get("751081630789140541"); //mesajın geleceği kanal idsi//
