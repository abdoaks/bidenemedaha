...
module.exports.run = async (bot, message, args) => {
    ...
    if (!args[0]) return message.channel.send("**Şarkı bilgisini bulmam için Spotify'dan şarkı dinleyen birisini etiketlemen gerekiyor.**")
    ...
    if (user.presence.game.name === 'Spotify' && user.presence.game.type === 2) {
        try {
            ...
            const embed = new Discord.RichEmbed()
                ...
                .setFooter(`Lewix Bot Spotify Sistemi ${message.author.username} tarafından istendi.`, "https://cdn.discordapp.com/emojis/515260605347659777.png?v=1")
                .setDescription(`
